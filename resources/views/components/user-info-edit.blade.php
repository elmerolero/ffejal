<div class="modal fade fixed top-0 left-0 w-full h-full bg-black hidden overflow-x-hidden overflow-y-auto usuario-editar" tabindex="-1" aria-modal="true" style="display: block; background: rgba( 0,0,0, 0.5);">
...
<script>
    document.addEventListener("DOMContentLoaded", function() {
        ...
        let eventoInfo = document.querySelector( ".usuario-editar" );
